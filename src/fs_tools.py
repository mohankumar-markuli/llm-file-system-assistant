"""
src/fs_tools.py — Core File System Tools Module (Part A)

This module provides 4 core tool functions for reading, listing, writing, and searching
resume documents (PDF, TXT, DOCX) with structured metadata responses and graceful error handling.
"""
...
def search_in_file(filepath: str, keyword: str) -> dict:
    ...
    try:
        ...
        # Handle directory search result
